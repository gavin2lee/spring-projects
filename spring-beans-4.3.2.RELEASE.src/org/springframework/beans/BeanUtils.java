...
/* 125 */     return instantiateClass(clazz);
/*     */   }
/*     */ 
...
/*     */ 
/* 330 */     String[] parameterTypeNames = StringUtils.commaDelimitedListToStringArray(signature
/* 330 */       .substring(firstParen + 1, lastParen));
/*     */ 
...
/*     */   {
/* 518 */     return (ClassUtils.isPrimitiveOrWrapper(clazz)) || (clazz.isEnum()) || 
/* 516 */       (CharSequence.class
/* 516 */       .isAssignableFrom(clazz)) || 
/* 517 */       (Number.class
/* 517 */       .isAssignableFrom(clazz)) || 
/* 518 */       (Date.class
/* 518 */       .isAssignableFrom(clazz)) || 
/* 518 */       (URI.class == clazz) || (URL.class == clazz) || (Locale.class == clazz) || (Class.class == clazz);
/*     */   }
/*     */ 
/*     */   public static void copyProperties(Object source, Object target)
/*     */     throws BeansException
/*     */   {
/* 537 */     copyProperties(source, target, null, (String[])null);
/*     */   }
/*     */ 
/*     */   public static void copyProperties(Object source, Object target, Class<?> editable)
/*     */     throws BeansException
/*     */   {
/* 555 */     copyProperties(source, target, editable, (String[])null);
/*     */   }
/*     */ 
/*     */   public static void copyProperties(Object source, Object target, String[] ignoreProperties)
/*     */     throws BeansException
/*     */   {
/* 573 */     copyProperties(source, target, null, ignoreProperties);
/*     */   }
/*     */ 
/*     */   private static void copyProperties(Object source, Object target, Class<?> editable, String[] ignoreProperties)
/*     */     throws BeansException
/*     */   {
/* 591 */     Assert.notNull(source, "Source must not be null");
/* 592 */     Assert.notNull(target, "Target must not be null");
/*     */ 
/* 594 */     Class actualEditable = target.getClass();
/* 595 */     if (editable != null) {
/* 596 */       if (!editable.isInstance(target))
/*     */       {
/* 598 */         throw new IllegalArgumentException("Target class [" + target.getClass().getName() + "] not assignable to Editable class [" + editable
/* 598 */           .getName() + "]");
/*     */       }
/* 600 */       actualEditable = editable;
/*     */     }
/* 602 */     PropertyDescriptor[] targetPds = getPropertyDescriptors(actualEditable);
/* 603 */     List ignoreList = ignoreProperties != null ? Arrays.asList(ignoreProperties) : null;
/*     */ 
/* 605 */     for (PropertyDescriptor targetPd : targetPds) {
/* 606 */       Method writeMethod = targetPd.getWriteMethod();
/* 607 */       if ((writeMethod != null) && ((ignoreList == null) || (!ignoreList.contains(targetPd.getName())))) {
/* 608 */         PropertyDescriptor sourcePd = getPropertyDescriptor(source.getClass(), targetPd.getName());
/* 609 */         if (sourcePd != null) {
/* 610 */           Method readMethod = sourcePd.getReadMethod();
/* 611 */           if ((readMethod != null) && 
/* 612 */             (ClassUtils.isAssignable(writeMethod
/* 612 */             .getParameterTypes()[0], readMethod.getReturnType())))
/*     */             try {
/* 614 */               if (!Modifier.isPublic(readMethod.getDeclaringClass().getModifiers())) {
/* 615 */                 readMethod.setAccessible(true);
/*     */               }
/* 617 */               Object value = readMethod.invoke(source, new Object[0]);
/* 618 */               if (!Modifier.isPublic(writeMethod.getDeclaringClass().getModifiers())) {
/* 619 */                 writeMethod.setAccessible(true);
/*     */               }
/* 621 */               writeMethod.invoke(target, new Object[] { value });
/*     */             }
/*     */             catch (Throwable ex)
/*     */             {
/* 625 */               throw new FatalBeanException("Could not copy property '" + targetPd
/* 625 */                 .getName() + "' from source to target", ex);
/*     */             }
/*     */         }
/*     */       }
/*     */     }
