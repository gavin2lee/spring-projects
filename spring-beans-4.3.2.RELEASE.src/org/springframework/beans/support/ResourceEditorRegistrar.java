...
/* 130 */     doRegisterEditor(registry, [Ljava.lang.Class.class, new ClassArrayEditor(classLoader));
/*     */ 
/* 132 */     if ((this.resourceLoader instanceof ResourcePatternResolver))
/* 133 */       doRegisterEditor(registry, [Lorg.springframework.core.io.Resource.class, new ResourceArrayPropertyEditor((ResourcePatternResolver)this.resourceLoader, this.propertyResolver));
/*     */   }
/*     */ 
