...
/*     */   {
/*  65 */     Set checkedElements = new LinkedHashSet(this.injectedElements.size());
...
/*  80 */     Collection elementsToIterate = this.checkedElements != null ? this.checkedElements : this.injectedElements;
/*     */     boolean debug;
...
/*     */   {
/*  97 */     Collection elementsToIterate = this.checkedElements != null ? this.checkedElements : this.injectedElements;
/*     */ 
...
/*     */         {
/* 149 */           throw new IllegalStateException("Specified field type [" + fieldType + "] is incompatible with resource type [" + resourceType
/* 149 */             .getName() + "]");
/*     */         }
/*     */       }
/*     */       else
/*     */       {
/* 154 */         Class paramType = this.pd != null ? this.pd
/* 154 */           .getPropertyType() : ((Method)this.member).getParameterTypes()[0];
/* 155 */         if ((!resourceType.isAssignableFrom(paramType)) && (!paramType.isAssignableFrom(resourceType)))
/*     */         {
/* 157 */           throw new IllegalStateException("Specified parameter type [" + paramType + "] is incompatible with resource type [" + resourceType
/* 157 */             .getName() + "]");
/*     */         }
/*     */       }
/*     */     }
