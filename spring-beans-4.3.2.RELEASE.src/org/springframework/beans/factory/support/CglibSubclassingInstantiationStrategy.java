...
/*     */   }
/*     */ 
/*     */   private static class ReplaceOverrideMethodInterceptor extends CglibSubclassingInstantiationStrategy.CglibIdentitySupport
...
/*     */   }
/*     */ 
/*     */   private static class LookupOverrideMethodInterceptor extends CglibSubclassingInstantiationStrategy.CglibIdentitySupport
/*     */     implements MethodInterceptor
/*     */   {
/*     */     private final BeanFactory owner;
/*     */ 
...
/*     */   }
/*     */ 
/*     */   private static class MethodOverrideCallbackFilter extends CglibSubclassingInstantiationStrategy.CglibIdentitySupport
...
/*     */       }
/*     */ 
/* 261 */       throw new UnsupportedOperationException("Unexpected MethodOverride subclass: " + methodOverride
...
/*     */     {
/* 178 */       return (getClass() == other.getClass()) && 
/* 178 */         (this.beanDefinition
...
/*     */         {
/*     */           Object instance;
/* 127 */           throw new BeanInstantiationException(this.beanDefinition.getBeanClass(), "Failed to invoke constructor for CGLIB enhanced subclass [" + subclass
/* 127 */             .getName() + "]", ex);
/*     */         }
/*     */       Object instance;
