...
/* 132 */           (ClassUtils.hasMethod(ifc, setter
/* 132 */           .getName(), setter.getParameterTypes()))) {
/* 133 */           return true;
/*     */         }
/*     */       }
/*     */     }
...
/*     */ 
/* 197 */     TypeVariable[] declaredTypeVariables = method.getTypeParameters();
...
/* 205 */     for (TypeVariable currentTypeVariable : declaredTypeVariables) {
...
/*     */             {
/* 227 */               throw new IllegalStateException("Failed to resolve value type [" + typedValue
