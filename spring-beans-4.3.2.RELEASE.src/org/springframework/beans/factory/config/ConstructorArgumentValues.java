...
/*     */   {
/*  73 */     if (other != null) {
/*  74 */       for (Map.Entry entry : other.indexedArgumentValues.entrySet()) {
...
/* 167 */       (ClassUtils.matchesTypeName(requiredType, valueHolder
/* 167 */       .getType())))) && (
/* 168 */       (valueHolder
/* 168 */       .getName() == null) || ("".equals(requiredName)) || ((requiredName != null) && 
/* 169 */       (requiredName
/* 169 */       .equals(valueHolder
/* 169 */       .getName()))))) {
...
/* 282 */         (valueHolder
/* 282 */         .getName().equals(requiredName)))) && 
/* 285 */         ((valueHolder.getType() == null) || ((requiredType != null) && 
/* 286 */         (ClassUtils.matchesTypeName(requiredType, valueHolder
/* 286 */         .getType())))) && (
/* 289 */         (requiredType == null) || (valueHolder.getType() != null) || (valueHolder.getName() != null) || 
/* 290 */         (ClassUtils.isAssignableValue(requiredType, valueHolder
/* 290 */         .getValue()))))
/*     */       {
...
/* 389 */       (this.indexedArgumentValues
/* 389 */       .size() != that.indexedArgumentValues.size())) {
/* 390 */       return false;
/*     */     }
/* 392 */     Iterator it1 = this.genericArgumentValues.iterator();
/* 393 */     Iterator it2 = that.genericArgumentValues.iterator();
/*     */     ValueHolder vh1;
...
/*     */       }
/*     */     }
/* 401 */     for (Map.Entry entry : this.indexedArgumentValues.entrySet()) {
...
/* 418 */     for (Map.Entry entry : this.indexedArgumentValues.entrySet()) {
...
/* 563 */         (ObjectUtils.nullSafeEquals(this.value, other.value)) && 
/* 563 */         (ObjectUtils.nullSafeEquals(this.type, other.type)));
/*     */     }
/*     */ 
