...
/*     */   {
/* 147 */     if (isSingleton()) {
/* 148 */       return this.initialized ? this.singletonInstance : getEarlySingletonInstance();
/*     */     }
/*     */ 
/* 151 */     return createInstance();
/*     */   }
/*     */ 
...
/* 164 */         getClass().getName() + " does not support circular references");
/*     */     }
...
/*     */     }
/*     */ 
/* 170 */     return this.earlySingletonInstance;
/*     */   }
/*     */ 
...
/*     */     }
/* 182 */     return this.singletonInstance;
/*     */   }
/*     */ 
/*     */   public void destroy()
/*     */     throws Exception
...
/*     */       {
/* 263 */         return "Early singleton proxy for interfaces " + 
/* 263 */           ObjectUtils.nullSafeToString(AbstractFactoryBean.this
/* 263 */           .getEarlySingletonInterfaces());
/*     */       }
/*     */       try {
