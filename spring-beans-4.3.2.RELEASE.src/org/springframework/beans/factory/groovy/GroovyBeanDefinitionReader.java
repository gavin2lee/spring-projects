...
/*     */       int index;
/* 304 */       if (!ObjectUtils.isEmpty(args)) {
...
/* 333 */       for (Map.Entry entry : definition.entrySet()) {
...
/*     */         }
/*     */ 
/* 340 */         NamespaceHandler namespaceHandler = this.groovyDslXmlBeanDefinitionReader
/* 340 */           .getNamespaceHandlerResolver().resolve(uri);
...
/* 461 */       Class beanClass = (args[0] instanceof Class) ? (Class)args[0] : args[0].getClass();
...
/* 466 */               resolveConstructorArguments(args, 1, args.length - 1));
/*     */           }
/*     */           else
/*     */           {
...
/* 474 */             resolveConstructorArguments(args, 1, args.length));
/*     */         }
/*     */ 
/*     */       }
/*     */ 
...
/* 489 */         for (localIterator = namedArgs.keySet().iterator(); localIterator.hasNext(); ) { Object o = localIterator.next();
...
/* 506 */           this.currentBeanDefinition = new GroovyBeanDefinitionWrapper(beanName, null, 
/* 507 */             resolveConstructorArguments(args, 1, endOfConstructArgs));
/*     */         }
/*     */         else
/*     */         {
...
/* 564 */     for (Iterator localIterator = map.values().iterator(); localIterator.hasNext(); ) { Object element = localIterator.next();
...
/* 586 */     for (Iterator localIterator = list.iterator(); localIterator.hasNext(); ) { Object element = localIterator.next();
...
/*     */       {
/* 765 */         return new GroovyPropertyValue(property, this.beanDefinition
...
/* 815 */         for (Iterator localIterator = values.iterator(); localIterator.hasNext(); ) { Object value = localIterator.next();
...
/* 835 */           GroovyBeanDefinitionReader.this.deferredProperties.put(GroovyBeanDefinitionReader.GroovyRuntimeBeanReference.this.beanDefinition.getBeanName(), new GroovyBeanDefinitionReader.DeferredProperty(GroovyBeanDefinitionReader.GroovyRuntimeBeanReference.this.beanDefinition, 
/* 836 */             this.propertyName, this.propertyValue));
/*     */       }
/*     */     }
/*     */   }
/*     */ 
