...
/*     */   {
/*  66 */     super(new StringBuilder().append("Error creating bean").append(beanName != null ? new StringBuilder().append(" with name '").append(beanName).append("'").toString() : "").append(": ").append(msg).toString());
...
/*     */   {
/*  89 */     super(new StringBuilder().append("Error creating bean").append(beanName != null ? new StringBuilder().append(" with name '").append(beanName).append("'").toString() : "").append(resourceDescription != null ? new StringBuilder().append(" defined in ").append(resourceDescription).toString() : "").append(": ").append(msg).toString());
/*     */ 
...
/* 195 */           (((NestedRuntimeException)relatedCause)
