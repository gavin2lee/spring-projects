...
/*     */   {
/* 114 */     Map handlerMappings = getHandlerMappings();
...
/*     */       {
/* 128 */         throw new FatalBeanException("Class [" + className + "] for namespace [" + namespaceUri + "] does not implement the [" + NamespaceHandler.class
...
/*     */             }
/* 159 */             Map handlerMappings = new ConcurrentHashMap(mappings.size());
