...
/* 203 */         String[] locations = StringUtils.commaDelimitedListToStringArray(location);
/* 204 */         builder.addPropertyValue("locations", locations);
/*     */       }
/*     */ 
/* 207 */       builder.addPropertyValue("ignoreResourceNotFound", 
/* 208 */         Boolean.valueOf(element
/* 208 */         .getAttribute("ignore-resource-not-found")));
/*     */ 
/* 210 */       builder.addPropertyValue("localOverride", 
/* 211 */         Boolean.valueOf(element
/* 211 */         .getAttribute("local-override")));
/*     */ 
/* 213 */       String scope = element.getAttribute("scope");
/* 214 */       if (StringUtils.hasLength(scope))
/* 215 */         builder.setScope(scope);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder)
/*     */     {
/* 173 */       Map parsedMap = parserContext.getDelegate().parseMapElement(element, builder.getRawBeanDefinition());
...
/*     */     protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder)
/*     */     {
/* 148 */       Set parsedSet = parserContext.getDelegate().parseSetElement(element, builder.getRawBeanDefinition());
...
/*     */     protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder)
/*     */     {
/* 123 */       List parsedList = parserContext.getDelegate().parseListElement(element, builder.getRawBeanDefinition());
