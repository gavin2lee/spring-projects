...
/*     */ 
/* 155 */     return (methodName.length() > 3) && (methodName.startsWith("set")) && (Modifier.isPublic(method.getModifiers())) && 
/* 155 */       ((!Void.TYPE
/* 155 */       .isAssignableFrom(method
/* 155 */       .getReturnType())) || (Modifier.isStatic(method.getModifiers()))) && (
/* 155 */       (nParams == 1) || ((nParams == 2) && (Integer.TYPE == parameterTypes[0])));
/*     */   }
/*     */ 
...
/* 199 */           (candidateType
/* 199 */           .equals(propertyType)) || 
/* 199 */           (candidateType.equals(propertyType.getComponentType()))))
/* 200 */           return pd;
/*     */       }
/*     */       else
/*     */       {
...
/* 206 */           (candidateType
/* 206 */           .equals(propertyType)) || 
/* 206 */           (propertyType.equals(candidateType.getComponentType())))) {
/* 207 */           return pd;
/*     */         }
/*     */       }
/*     */     }
...
/*     */ 
/* 477 */       return (ObjectUtils.nullSafeEquals(getIndexedReadMethod(), otherPd.getIndexedReadMethod())) && 
...
/*     */     public boolean equals(Object other)
/*     */     {
/* 334 */       return (this == other) || (((other instanceof PropertyDescriptor)) && 
