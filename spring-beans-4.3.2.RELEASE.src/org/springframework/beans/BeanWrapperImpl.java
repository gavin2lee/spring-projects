...
/*     */ 
/* 243 */     throw new NotWritablePropertyException(
/* 242 */       getRootClass(), getNestedPath() + propertyName, matches
...
/*     */         try {
/* 307 */           return AccessController.doPrivileged(new PrivilegedExceptionAction()
/*     */           {
...
/*     */       throws Exception
/*     */     {
/* 327 */       final Method writeMethod = (this.pd instanceof GenericTypeAwarePropertyDescriptor) ? ((GenericTypeAwarePropertyDescriptor)this.pd)
/* 326 */         .getWriteMethodForActualAccess() : this.pd
/* 327 */         .getWriteMethod();
