...
/*     */ 
/*  48 */     Enumeration keys = source.attributeNames();
...
/*     */   {
/* 171 */     return (ObjectUtils.nullSafeEquals(pd.getReadMethod(), otherPd.getReadMethod())) && 
/* 168 */       (ObjectUtils.nullSafeEquals(pd
/* 168 */       .getWriteMethod(), otherPd.getWriteMethod())) && 
/* 169 */       (ObjectUtils.nullSafeEquals(pd
/* 169 */       .getPropertyType(), otherPd.getPropertyType())) && 
/* 170 */       (ObjectUtils.nullSafeEquals(pd
/* 170 */       .getPropertyEditorClass(), otherPd.getPropertyEditorClass())) && 
/* 171 */       (pd
