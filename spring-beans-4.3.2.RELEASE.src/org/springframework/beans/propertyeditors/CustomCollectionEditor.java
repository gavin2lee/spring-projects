...
/*     */     {
/*  91 */       throw new IllegalArgumentException("Collection type [" + collectionType
...
/* 121 */       Collection target = createCollection(this.collectionType, source.size());
/* 122 */       for (Iterator localIterator = source.iterator(); localIterator.hasNext(); ) { Object elem = localIterator.next();
...
/* 130 */       Collection target = createCollection(this.collectionType, length);
...
/*     */     else
/*     */     {
/* 138 */       Collection target = createCollection(this.collectionType, 1);
...
/*     */       catch (Throwable ex)
/*     */       {
/* 159 */         throw new IllegalArgumentException("Could not instantiate collection class: " + collectionType
/* 159 */           .getName(), ex);
/*     */       }
/*     */     }
