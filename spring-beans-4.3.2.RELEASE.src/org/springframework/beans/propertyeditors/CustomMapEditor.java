...
/*     */     {
/*  81 */       throw new IllegalArgumentException("Map type [" + mapType
...
/* 111 */       Map target = createMap(this.mapType, source.size());
...
/*     */       catch (Throwable ex)
/*     */       {
/* 137 */         throw new IllegalArgumentException("Could not instantiate map class: " + mapType
/* 137 */           .getName(), ex);
/*     */       }
/*     */     }
