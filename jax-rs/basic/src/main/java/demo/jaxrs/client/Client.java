...
public final class Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        URL url = new URL("http://localhost:9009/customerservice/customers/123");
        ...
        url = new URL("http://localhost:9009/customerservice/orders/223/products/323");
        in = url.openStream();
        System.out.println(getStringFromInputStream(in));
        ...
        PutMethod put = new PutMethod("http://localhost:9009/customerservice/customers");
        ...
        PostMethod post = new PostMethod("http://localhost:9009/customerservice/customers");
