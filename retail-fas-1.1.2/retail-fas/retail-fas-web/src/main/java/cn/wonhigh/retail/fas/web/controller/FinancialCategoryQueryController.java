 ...
 */
@Controller
@RequestMapping("/financial_category_query")
public class FinancialCategoryQueryController extends BaseController<FinancialCategoryDto> {
   
	private static final XLogger LOGGER = XLoggerFactory.getXLogger(FinancialCategoryQueryController.class);
    ...
    public CrudInfo init() {
        return new CrudInfo("financial_category_query/",financialCategoryManager);
    }
    ...
    @RequestMapping("/list")
    public String list() {
    	return "financial_category/query_page";
    }
    ...
    public Map<String, Object> query(Model model, HttpServletRequest request) throws ManagerException {
    	try {
			...
			int total = financialCategoryManager.findRelationCount(params);
			
			SimplePage page = new SimplePage(pageNo, pageSize, (int) total);
			List<FinancialCategoryDto> list = financialCategoryManager.findRelationByPage(page, sortColumn, sortOrder, params);
    ...
    */
	@Override
	protected List<FinancialCategoryDto> queryExportData(Map<String, Object> params) throws ManagerException {
		int total = financialCategoryManager.findRelationCount(params);
		...
		List<FinancialCategoryDto> list = financialCategoryManager.findRelationByPage(page, orderByField, orderBy, params);
		return list;
	} 
}