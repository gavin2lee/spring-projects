...
function loadWarnMessage(dataGridId){
	...
	if(warnPostUrl != null && warnPostUrl != ''){
		...
		if($('#mainDataGrid').length>0){
			...
			setTimeout("loadWarnMessage()", 3000);
		}
	}
}
...
yearData = (function(){
	...
	return [{"value":year-1,"text":year-1},{"value":year,"text":year}]
})();

monthData = [{"value":"1","text":"1"},{"value":"2","text":"2"},
