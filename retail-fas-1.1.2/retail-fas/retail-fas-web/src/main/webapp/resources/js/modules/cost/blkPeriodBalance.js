function BLKPeriodBalanceDialog() { 
	...
	this.generateOwerGuest = function() {
		...
		var saveFn = function() {
			...
			var url = BasePath + '/blk_company_period_balance/generate_ower_guest.json';
...
var dialog = null;
$(function() {
	$.fas.extend(BLKPeriodBalanceDialog, FasDialogController);
	dialog = new BLKPeriodBalanceDialog();
	dialog.init("/blk_period_balance", {
		dataGridId : "dataGridDiv",
		searchBtn : "btn-search",
		searchUrl : "/blk_period_balance.json",
		searchFormId : "searchForm",
		exportTitle : "巴洛克-期间结存导出",
