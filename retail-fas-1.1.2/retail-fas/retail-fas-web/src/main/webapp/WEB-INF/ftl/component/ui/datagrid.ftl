...
<#macro datagrid
	...
	onLoadSuccess=""  showFooter="false" onCheck="" onUncheck="" onCheckAll="" onUncheckAll="" showDisplayMsg="true" rowStyler="">  
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var $dgExtend={
            ...
            pageList:[10,20,50,100,200,300,400,500,1000,2000],
            collapsible:false,
            <#if border='true'>
                border:true,
                <#else>
        ...
        seajs.use(['gms/authority'], function (authority){
        	//var organType = authority.getUserInfo().organTypeNo;
        	$.fas.filterColumns($dg,opt.columns,authority);
        	$dg.datagrid(opt);
        });       
        function endEdit(){
            var rows = $dg.datagrid('getRows');
