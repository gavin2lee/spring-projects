<script type="text/javascript" src="${resourcesUrl}/fas/resources/common/js/jquery-1.6.4.min.js?version=${version}"></script>
<script type="text/javascript" src="${resourcesUrl}/fas/resources/common/js/jquery.easyui.min.js?version=${version}"></script>
<script type="text/javascript"  src="${resourcesUrl}/fas/resources/js/tree.js?version=${version}"></script>
<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/resources.js?version=${version}"></script>
<style>
<!--
* {
    margin: 0;
