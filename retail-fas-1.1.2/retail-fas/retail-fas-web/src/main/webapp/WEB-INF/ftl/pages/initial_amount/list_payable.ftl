...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" class="toolbar-region">
	     <@p.toolbar id="toolbar" listData=[
             ...
             {"id":"btn-export","title":"导出","iconCls":"icon-export","action":"common_util.doExport('dtlDataGrid','/initial_amount/export','初始应付余额信息导出')","type":4},
             {"id":"btn-import","title":"导入","iconCls":"icon-import","action":"common_util.doImport('初始应付余额.xlsx','/initial_amount/do_import',1,initialAmount.importCallBack)","type":6}
           ]
		/>
	</div>
		      ...
		      <@p.datagrid id="dtlDataGrid"  loadUrl="" saveUrl=""  showFooter="true" defaultColumn=""  pageSize="20" 
		              isHasToolBar="false"    onClickRowEdit="false" pagination="true"  emptyMsg = "" rownumbers="true"
			           columnsJsonList="[
			                 ...
			                 {field : 'supplierName', title : '供应商', width : 300, editor:{type:'test_combogrid',options:{type:'supplier',required:true,datagridId:'dtlDataGrid',valueField:'supplierNo'}}, align:'left'},
