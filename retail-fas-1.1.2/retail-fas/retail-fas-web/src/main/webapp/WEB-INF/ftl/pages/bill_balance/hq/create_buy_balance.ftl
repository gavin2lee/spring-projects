						...
						<table class="form-tb">
							...
							<tbody>
								<tr>
                                    ...
                                    <td><input class="ipt disableEdit" singleSearch="company"  name="buyerName" data-options="required:true" notGroupLeadRole/><input type="hidden" name="buyerNo" /></td>
                                    <th><span class="ui-color-red">*</span>供应商：</th>
                                    <td><input class="ipt disableEdit" singleSearch="supplier"  name="salerName" data-options="required:true"/><input type="hidden" name="salerNo" /></td>
                                    <th><span class="ui-color-red">*</span>品牌部：</th>
                                    <td><input class="ipt disableEdit" singleSearch="brandUnit"  name="brandUnitName" data-options="required:true"/><input type="hidden" name="brandUnitNo"/></td>
						 ...
						 <@p.datagrid id="createBalanceDG"  loadUrl="" saveUrl=""   defaultColumn="" showFooter="true"
			              isHasToolBar="false"   onClickRowEdit="false" pagination="true" pageSize="500"
				           ...
				           columnsJsonList="[
			                  ...
			                  {field : 'cost', title : '采购价/地区价', width : 80, formatter: function(value,row,index){
									if(row.buyerName == '合计'){
										return '';
									}
									return value;
			                  ...
			                  {field : 'companyName', title : '订货公司', width : 200, align:'left'},
