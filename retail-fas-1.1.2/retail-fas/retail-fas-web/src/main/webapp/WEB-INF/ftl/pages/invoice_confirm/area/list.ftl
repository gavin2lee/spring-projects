	     ...
	     <div class="easyui-layout" data-options="fit:true" id="subLayout">
			...
			<div data-options="region:'north',border:false" >
				<div class="search-div">
				     ...
				     <input type="hidden" name="balanceTypeIn" value="(2,5)"/>
		       		 	<table class="form-tb">
		       		 		<col width="100" />
						    <col />
						    <col width="100" />
						    ...
						    <tbody>
		       		 		<tr>
		       		 			<th>结算类型：</th>
		       		 			<td>
		       		 				<input class="easyui-combobox ipt" name="balanceType" id="balanceTypeCondition" style="width:150px"
		       		 				 data-options="editable:false,valueField:'typeNo',textField:'typeName',url:BasePath + '/invoice_confirm/area/balance_type'"/>
		       		 			</td>
		       		 		    <th>发票登记号：</th>
		       		 			<td>
		       		 				<input class="easyui-validatebox ipt" name="billNo" style="width:120px"/>
		       		 			</td>
		       		 			<th>出票方：</th>
		       		 			<td>
		       		 				<input class="easyui-company ipt"  name="salerName" id="salerNameCond" 
		       		 				data-options="queryUrl: BasePath + '/base_setting/company/list.json?dataAccess=0',inputNoField:'salerNoCond',inputNameField:'salerNameCond',inputWidth:150,isDefaultData:false"/>
		       		 				<input type="hidden" name="salerNo" id="salerNoCond"/>
		       		 			</td>
		       		 			<th>收票方：</th>
		       		 			<td>
		       		 				<input class="easyui-company ipt"  name="buyerName" id="buyerNameCond" 
		       		 				data-options="queryUrl: BasePath + '/base_setting/company/list.json?params=groupLeadRole',inputNoField:'buyerNoCond',inputNameField:'buyerNameCond',inputWidth:150,isDefaultData:false"/>
		       		 		...
		       		 		<tr>
		       		 			...
		       		 			<th>确认人：</th>
		       		 			<td>
		       		 				<input class="easyui-validatebox ipt"  name="confirmUser"  style="width:120px"/>
		       		 			</td>
		       		 			<th>确认日期：</th>
							    <td>
