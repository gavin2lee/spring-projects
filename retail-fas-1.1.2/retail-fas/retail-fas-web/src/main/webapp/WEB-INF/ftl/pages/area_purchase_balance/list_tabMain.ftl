<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'north',border:false" class="toolbar-region">
		 <@p.billToolBar type="area_purchase_mainBar"/>
	</div>
				  ...
				  <form name="searchForm" id="searchForm" method="post">
				    ...
				    <tbody>
				    	<tr>
				    	    <th>单据编号：</th>
                            <td>
                            	<input class="easyui-validatebox"  name="billNo" id="billNoCond" style="width: 155px;"/>
                            </td>
                            <th>单据状态：</th>
						    <td>
								<select class="easyui-combobox"  name="status" id="status" style="width:130px;"
						        data-options="editable:false,valueField:'statusNo',textField:'statusName',url:BasePath + '/area_balance_common/getASBalanceBillStatus'"/>						
						    </td>
							<th>品牌部： </th>
							<td>
			      ...
			      <@p.datagrid id="mainDataGrid"  loadUrl="" saveUrl=""   defaultColumn="" 
			              isHasToolBar="false" onClickRowEdit="false" pagination="true" selectOnCheck="true" 
				           ...
				           columnsJsonList="[
								...
								{field : 'status',title : '单据状态',width : 100,align:'center',formatter:areaBuyBalance.statusFormat},
					          ...
					          jsonExtend='{
			                           onDblClickRow:function(rowIndex, rowData){
			                               //双击方法
					                   	  areaBuyBalance.loadDetail(rowIndex,rowData);
					                   }
			         }'/>
			</div>
		 </div>
