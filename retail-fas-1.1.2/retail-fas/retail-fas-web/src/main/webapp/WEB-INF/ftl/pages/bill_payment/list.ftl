            ...
            <div class="easyui-layout" data-options="fit:true">
                	<div data-options="region:'north',border:false">
                    	<@p.toolbar id="toor_bar" listData=[
							...
							{"id":"top_btn_5","title":"审批日志","iconCls":"icon-cancel","action":"billController.toOperateLog(4)","type":0}
			                        	 ...
			                        	 <table class="form-tb">
			                               ...
			                               <tbody>
			                                    ...
			                                    <tr>
			                                    	...
			                                    	<th>源单编码：</th>
			                                        <td><input class="easyui-validatebox  ipt" iptSearch name="refBillNo" id="refBillNo"/><input  type="hidden" name="invoiceAmount" id="invoiceAmount"/></td>
			                                    </tr>
			                                    <tr>
			                                        <th>币别：</th>
