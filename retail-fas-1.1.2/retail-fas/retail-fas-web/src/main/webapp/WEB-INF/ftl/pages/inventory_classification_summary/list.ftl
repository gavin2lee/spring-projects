...
<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/inventory_classification_summary/inventory_classification_summary.js?version=${version}"></script>
</head>
		                 ...
		                 <tbody>
							...
							<tr>
								<th><span class="ui-color-red">*</span>年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;份：</th>
							 	<td>
							 		<input class="easyui-combobox"  data-options="required:true,inputWidth:160"   name="year" id="yearCondition"/>
							 	</td>
								<th><span class="ui-color-red">*</span>月&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;份：</th>
							 	...
							 	<th>商品年份：</th>
							 	<td>
							 		<input class="easyui-combobox"  data-options="inputWidth:160"  name="years" id="yearCondition1"/>
							 	</td>
							</tr>
						 </tbody>
						</table>
