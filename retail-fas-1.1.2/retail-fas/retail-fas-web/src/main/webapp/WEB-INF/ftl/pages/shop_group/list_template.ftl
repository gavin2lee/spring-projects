		...
		<div  data-options="region:'center',border:false">
							 ...
							 <form name="dialog_SarchForm" id="dialog_SarchForm" method="post">
							 	<table class="form-tb">
					                 ...
					                 <tbody>
								    		<tr>
						       		 			<th>开票模板编码：</th>
						       		 			<td><input class="easyui-validatebox ipt" name="invoiceTempNo" id="invoiceTempNoCondition"/></td>
						       		 			<th>开票模板名称：</th>
			...
			<div data-options="region:'center',border:false">
				<@p.datagrid id="dialog_SearchDataGrid"  loadUrl="" saveUrl=""  defaultColumn="" 
					               ...
					               columnsJsonList="[
					               	  {field : 'invoiceTempNo',title : '开票模板编码',width : 150, halign : 'center', align : 'left'},
					        	      {field : 'name',title : '开票模板名称',width : 200, halign : 'center', align : 'left'}
					                 ]" 
								/>
			</div>
		</div>
