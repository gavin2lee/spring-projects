...
<script type="text/javascript">
	...
	function allotSystemRole(){
		...
		openwindow("toSelectUserOrganiz.htm",550,450,"选择用户组织机构");
	}
...
<script type="text/javascript">
    ...
    function init(){
       $('#storeNo').combogrid({
         ...
         columns:[[  
             {field:'storeNo',title:'机构编号',width:140},  
             {field:'storeName',title:'机构名称',width:140}  
         ]]  
	   });
    }
</script>
			...
			<div class="modify" id="modify">
				<div class="add_detail_box">
			       ...
			       <p>
			       	...
			       	<p>
						<span>
			       			<label for="msnNum">所属机构：<font color="red">*</font>&nbsp;</label>
