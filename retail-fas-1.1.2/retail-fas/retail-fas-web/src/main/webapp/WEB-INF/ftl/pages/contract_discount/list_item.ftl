...
<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/contract_discount/contractDiscountItem.js?version=${version}"></script>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',border:false" class="toolbar-region">
	     <@p.toolbar id="toolbar" listData=[
			 {"id":"btn-search","title":"查询","iconCls":"icon-search","action":"contractDiscountItem.searchData()", "type":0},
             {"id":"btn-remove","title":"清空","iconCls":"icon-empty","action":"contractDiscountItem.searchClear()", "type":0},
             {"id":"btn-add","title":"新增","iconCls":"icon-add","action":"contractDiscountItem.add()", "type":1},
             {"id":"btn-del","title":"删除","iconCls":"icon-del","action":"contractDiscountItem.del()", "type":3},
             {"id":"btn-save","title":"保存","iconCls":"icon-save","action":"contractDiscountItem.save()", "type":7},
             {"id":"btn-import","title":"导入","iconCls":"icon-export","action":"pe_util.doImport('供应商指定价设置.xlsx','/contract_discount/do_import?type=3',16,pe_util.importCallBack)","type":6},
             {"id":"btn-export","title":"导出","iconCls":"icon-export","action":"pe_util.doExport('dtlDataGrid', '/contract_discount/export_data', '供应商指定价')","type":4}
           ]
		/>
	</div>
			...
			<div data-options="region:'north',border:false" >
				<div class="search-div">
			      	<form name="searchForm" id="searchForm" method="post">
			      		<input type="hidden" name="contractDiscountType" value="3" id="contractDiscountType"/>
						<table class="form-tb">
							<col width="80" />
							<col />
							<col width="80" />
		      ...
		      <@p.datagrid id="dtlDataGrid"  loadUrl="" saveUrl=""   defaultColumn=""   rownumbers="true"
		              isHasToolBar="false"    onClickRowEdit="false" pagination="true"  emptyMsg = ""  pageSize="20" 
			           columnsJsonList="[
			                  ...
			                  {field : 'categoryNo', title : '大类',  hidden:'true'},
			                  {field : 'itemNo', title : '商品ID',hidden:'true'},
			                  ...
			                  jsonExtend='{
	                           onDblClickRow:function(rowIndex, rowData){
			                	  //双击方法
			                   	   contractDiscountItem.edit(rowIndex, rowData);
			              		}}'
                 />
			</div>
	 	</div>
              ...
              isHasToolBar="false"    onClickRowEdit="false" pagination="false"  emptyMsg = ""
	           columnsJsonList="[
                     ...
                     {field : 'validateObj.salerNo', title : '供应商编码', width : 100},
	 				 ...
	 				 {field : 'validateObj.purchasePrice',title:'采购价',width:100,align:'right'},
