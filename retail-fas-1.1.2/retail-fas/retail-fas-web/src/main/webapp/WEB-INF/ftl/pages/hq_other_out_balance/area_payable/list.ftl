...
<head>
<meta charset="UTF-8">
<title>地区其他入库-结算单</title>
<#include  "/WEB-INF/ftl/common/header.ftl" >
	<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/common/balanceBillCommon.js?version=${version}"></script>
	<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/area_other_stock_in/areaOtherStockInBalance.js?version=${version}"></script>
     ...
     <div data-options="title:'单据明细'">
         <div class="easyui-layout" data-options="fit:true">
            	<div data-options="region:'north',border:false">
					  <@p.billToolBar type="area_other_in_balance"/>
                </div>
		                        ...
		                        <form id="mainDataForm"  method="post">
		                         ...
		                         <input type="hidden"  name="invoiceApplyNo" id="invoiceApplyNo" />
									...
									<tr>
										<th>品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;牌： </th>
										<td>
											 <input class="easyui-validatebox  ipt"  name="brandName" id="brandNameId" style="width:180px;"/>
