<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'north',border:false" class="toolbar-region">
		<@p.billToolBar type="area_among_balance_listMainBar"/>
	</div>
				    ...
				    <tbody>
				    	<tr>
						    ...
						    <td>
						        ...
						        data-options="editable:false,valueField:'statusNo',textField:'statusName',url:BasePath + '/area_balance_common/getAABalanceBillStatus'"/>
						    </td>
						    <th>品牌部： </th>
							<td>
			      ...
			      <@p.datagrid id="mainDataGrid"  loadUrl="" saveUrl=""   defaultColumn="" 
			              isHasToolBar="false" onClickRowEdit="false" pagination="true" selectOnCheck="true" 
				           ...
				           columnsJsonList="[
								...
								{field : 'status',title : '单据状态',width : 115,align:'center',halign:'center',formatter:areaBalance.statusFormat},
