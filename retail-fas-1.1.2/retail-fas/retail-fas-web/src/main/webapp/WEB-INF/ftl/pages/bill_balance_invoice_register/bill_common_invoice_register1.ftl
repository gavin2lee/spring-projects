	...
	<div id="queryConditionDiv" data-options="region:'north',border:false">
		<@p.toolbar id="main_bar"	listData=[
				...
				<!--{"id":"mian_btn_cancel","title":"作废","iconCls":"icon-cancel","action":"billCommonInvoiceRegister.batchOperate(2)","type":0},-->			
				 {"id":"mian_btn_export","title":"导出","iconCls":"icon-export","action":"exportList()","type":4}
				...
				{"id":"invoice_btn_ok","title":"到票确认","iconCls":"icon-aduit","action":"billCommonInvoiceRegister.batchInvoiceOk()","type":32}
		]/>
	            ...
	            <table class="form-tb" >				    
				     ...
				     <tbody>	  
		                <tr>
		                	<th>结算类型：</th>
							<td> 
								<input name="balanceType" id="searchbalanceType" readonly/>
							</td>
		                	<th>单据编码：</th>
							<td>
							...
							<td> 
								...
								data-options="inputNoField:'buyerNoId',inputNameFeild:'buyerNameId'" />
			       		...
			       		<tr>
			       			<th>开票申请号：</th>
							<td>
								<input class="ipt" name="applyNo" id="applyNo" />
							</td> 
			       			<th>单据状态：</th>
							<td>
								<input class="easyui-combobox ipt" name="status" 
									data-options="valueField: 'value',textField: 'text',data:statusformatter " readonly/> 
							</td>
			       			<th>制单日期：</th>
						    <td>
		      ...
		      <@p.datagrid id="dataGridCommonInvoice"  loadUrl="" saveUrl=""   defaultColumn="" title=""
		              isHasToolBar="false" onClickRowEdit="false" pagination="true" selectOnCheck="true" 
			           ...
			           rownumbers="true" singleSelect="false" 				           
			             columnsJsonList="[
			              {field : 'id', checkbox:true, width : 40, notexport:true},
			              {field : 'balanceTypeName', title : '结算单类型', width : 150, align : 'center',halign:'center'},
			              {field : 'organName',title : '管理城市',width : 80,align:'center',halign:'center'},
			              {field : 'month',title : '结算月',width : 80,align:'center',halign:'center'},
			              {field : 'shortName', title : '店铺名称', width : 200, align : 'left',halign:'center'},
			              {field : 'brandName', title : '品牌名称', width : 80, align : 'left',halign:'center'},
			              {field : 'sourceNo', title : '开票申请单', width : 150, align : 'left',halign:'center', formatter: function(value,row,index){
								var title;
								if($('#isHQ').val() == 'true') {
									title = 'HI-开票申请';
								}else {
						  ...
						  {field : 'qty', title : '商品数量', width : 80, align : 'left',halign:'center'},
			              {field : 'buyerName', title : '客户名称', width : 200, align : 'left',halign:'center'},
			              {field : 'invoiceCode',title : '发票代码',width : 150,align : 'left' ,halign:'center'},
			              {field : 'invoiceNo',title : '发票号码',width : 150,align : 'left' ,halign:'center'},
			              {field : 'invoiceDate',title : '发票日期',width : 150,align : 'left' ,halign:'center'},
			              {field : 'amount',title : '发票金额',width : 80,align : 'left' ,halign:'center'},
			              {field : 'express',title : '快递公司',width : 200,align : 'left' ,halign:'center'},
			              {field : 'deliveryNo',title : '快递单号',width : 150,align : 'left' ,halign:'center'},
			              {field : 'deliveryDate',title : '快递日期',width : 150,align : 'left' ,halign:'center'},
			              {field : 'confirmUser',title : '确认人',width : 80,align : 'left' ,halign:'center'},
			              {field : 'confirmTime',title : '确认日期',width : 150,align : 'left' ,halign:'center'},
			              {field : 'remark',title : '备注',width : 150,align : 'left' ,halign:'center'},
			              {field : 'statusName',title : '单据状态',width : 80,align:'center',halign:'center'},
			              {field : 'billNo',title : '单据编码',width : 150,align:'center',halign:'center'},
