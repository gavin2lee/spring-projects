...
<head>
<meta charset="utf-8">
<title>跨区调货出库明细表</title>
	<#include  "/WEB-INF/ftl/common/header.ftl" >
	<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/common/area_detail.js?version=${version}"></script>
	<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/area_among/transferOut.js?version=${version}"></script>
	...
	<div data-options="title:'跨区调货明细表'">
		<div id="subLayoutId" class="easyui-layout" data-options="fit:true,border:false">
			...
			<div data-options="region:'north',border:false" class="toolbar-region">
			   	<@p.billToolBar type="area_among_transferList"/>
			</div>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										data-options="queryUrl: BasePath + '/base_setting/company/list.json?dataAccess=0&params=groupLeadRole',inputNoField:'buyerNoId',inputNameField:'buyerNameId',inputWidth:160,isDefaultData : false"/>
					...
					<@p.datagrid id="dataGridJG"  loadUrl="" saveUrl=""   defaultColumn="" 
		              isHasToolBar="false"    onClickRowEdit="false" pagination="true" 
			           ...
			           columnsJsonList="[
			                  ...
			                  {field : 'unitCost', title : '进货成本', width : 80,align:'right',halign:'center'},
			                  {field : 'purchasePrice', title : '采购价', width : 80,align:'right',halign:'center'},
			                  ...
			                  {field : 'purchaseAmount', title : '采购金额', width : 80,align:'right',halign:'center'},
			                  {field : 'sendDate', title : '发出日期', width : 100,align:'center',sortField:'send_date',sortable:true},
