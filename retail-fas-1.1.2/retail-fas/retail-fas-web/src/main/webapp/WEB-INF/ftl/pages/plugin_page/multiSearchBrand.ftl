							 ...
							 <form name="dialog_SarchForm" id="dialog_SarchForm" method="post">
							 	<table class="form-tb">
					                 ...
					                 <tbody>
								    		<tr>
						       		 			<th>品牌编码：</th>
						       		 			<td><input class="easyui-validatebox ipt" name="brandNo" id="brandNoCondition"/></td>
						       		 			<th>品牌名称：</th>
						       		 			<td><input class="easyui-validatebox ipt"  name="name" id="brandNameCondition"/></td>
						       		 		</tr>
								    </tbody>
							   </table>
							</form>
				...
				<@p.datagrid id="dialog_SearchDataGrid"  loadUrl="" saveUrl=""  defaultColumn="" 
					               ...
					               columnsJsonList="[
					              	  {field : 't',checkbox:true,width : 30},
					               	  {field : 'brandNo',title : '品牌编码',width : 150, halign : 'center', align : 'left'},
					        	      {field : 'name',title : '品牌名称',width : 200, halign : 'center', align : 'left'}
					                 ]" 
								/>
			</div>
		</div>
