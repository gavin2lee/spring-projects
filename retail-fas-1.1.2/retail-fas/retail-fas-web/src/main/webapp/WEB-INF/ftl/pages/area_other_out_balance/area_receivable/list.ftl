...
<head>
<meta charset="UTF-8">
<title>地区其他出库-结算单</title>
<#include  "/WEB-INF/ftl/common/header.ftl" >
	<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/common/balanceBillCommon.js?version=${version}"></script>
	<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/area_other_stock_out/otherStockOutBalance.js?version=${version}"></script>
        ...
        <div data-options="title:'单据明细'">
            <div class="easyui-layout" data-options="fit:true">
                	...
                	<div data-options="region:'north',border:false">
						 <@p.billToolBar type="area_other_balance"/>
                    </div>
		                          ...
		                          <input type="hidden" name="id" id="id">
									...
									<tr>
										...
										<td>
											...
											data-options="queryUrl: BasePath + '/base_setting/company/list.json?dataAccess=0&params=notGroupLeadRole',required:true,inputNoField:'buyerNoId',inputNameField:'buyerNameId',inputWidth:200,isDefaultData : false"/>
                ...
                <tbody>
				   ...
				   <tr>
                        ...
                        <td>
                    		...
                    		data-options="multiple:true,queryUrl: BasePath + '/base_setting/company/list.json?dataAccess=0&params=notGroupLeadRole',required:true,inputNoField:'buyerNo',inputNameField:'buyerName',inputWidth:200,isDefaultData : false" />
