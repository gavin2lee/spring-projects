<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'north',border:false">
    	<@p.toolbar id="balanceDeductBar" listData=[
			{"id":"addDeductBtn","title":"新增行","iconCls":"icon-add-dtl","action":"balanceDeductEditor.insertRow()","type":0},
			{"id":"delDeductBtn","title":"删除行","iconCls":"icon-del-dtl","action":"balanceDeductEditor.deleteRow()","type":0}
		 ]/>
    </div>
	<div data-options="region:'center',border:false" id="balanceDeductDataGridDiv">
      <@p.datagrid id="balanceDeductDataGrid"  loadUrl="" saveUrl=""   defaultColumn="" title=""  pageSize="20"  
              isHasToolBar="false" onClickRowEdit="false" pagination="true"  rownumbers="true"  showFooter="true"
	           columnsJsonList="[
				    ...
				    {field : 'diffReason',title : '差异原因',width : 100,align:'center',								
	                  ...
	                  {field : 'processStatus',title : '处理状态 ',width : 70,align:'left',
	                   	formatter: balanceDeduct.processStatus,printable:false, 				                  	
	                  	editor:{				                     
	                  		type:'combobox',
	                  		options:{
	                  ...
	                  {field : 'createUser',title : '建档人',width : 60,align:'left',printable:false}, 
		          	 ...
		          	 jsonExtend='{
	                    onDblClickRow:function(rowIndex, rowData){
		                   	   balanceDeductEditor.editRow(rowIndex, rowData);	
		                }
         }'/>
	</div>
</div>