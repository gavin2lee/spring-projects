<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'north',border:false">
		<@p.toolbar id="toolbar2" listData=[
			...
			{"id":"bill-btn-export","title":"导出","iconCls":"icon-export","action":"_fasBillController.exportExcel()","type":4}			
		]/>
	...
	<div data-options="region:'center',border:false">
		<@p.datagrid id="billTabDataGrid"  
			...
			columnsJsonList="[
				...
				{field : 'saleOrderNo',title : '销售订单编码',width : 120},
			...
			jsonExtend='{onDblClickRow:function(rowIndex, rowData){
				_billPrePaymentNt.loadDetail(rowIndex, rowData);
		}}'/>
	</div>
</div>
