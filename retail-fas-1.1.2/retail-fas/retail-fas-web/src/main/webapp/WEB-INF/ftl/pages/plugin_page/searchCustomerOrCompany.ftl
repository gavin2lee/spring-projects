		...
		<div data-options="region:'north',border:false" class="toolbar-region">
			  <table width="100%">
				<tr class="datagrid-toolbar">
					<td>
					 <@p.toolbar id="searchCustomerOrCompanyTool" listData=[ 
							 	...
							 	<table class="form-tb">
					                 ...
					                 <tbody>
								    		<tr>
								    			<th>数据源：</th>
						       		 			<td>
						       		 				<input class="ipt" name="dataSourceType" id="dataSourceTypeConditioin" />
						       		 			</td>
						       		 			<th id="noCondition">客户编码：</th>
						       		 			<td><input class="easyui-validatebox ipt" name="customerNo" id="inputNoCondition"/></td>
						       		 			<th id="nameCondition">客户名称：</th>
						       		 			<td><input class="easyui-validatebox ipt"  name="fullName" id="inputNameCondition"/></td>
						       		 		</tr>
								    </tbody>
							   </table>
							</form>
