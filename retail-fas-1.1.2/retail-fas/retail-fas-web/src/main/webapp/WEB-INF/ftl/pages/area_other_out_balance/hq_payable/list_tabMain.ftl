<div class="easyui-layout" data-options="fit:true,border:false">
	<div id="queryConditionDiv" data-options="region:'north',border:false">
		<@p.billToolBar type="hq_other_mainBar"/>
	</div>
				    ...
				    <tbody>
				    	<tr>
						    ...
						    <td>
						        ...
						        data-options="editable:false,valueField:'statusNo',textField:'statusName',url:BasePath + '/area_balance_common/getHqOtherBalanceStatus'"/>
						    </td>
						    <th>品牌部： </th>
							<td>
						...
						<tr>
                            ...
                            <td>
                             ...
                             data-options="queryUrl: BasePath + '/base_setting/company/list.json?params=notGroupLeadRole',inputNoField:'buyerNoCon',inputNameField:'buyerNameCon',inputWidth:160,isDefaultData : false"/>
	...
	<div data-options="region:'center',border:false">
				<@p.datagrid id="mainDataGrid"  
					...
					columnsJsonList="[
						...
						{field : 'extendStatus',title : '单据状态',width : 100,align:'center',halign:'center',formatter:areaOtherBalance.statusFormat},
