    	...
    	<div class="easyui-layout" data-options="fit:true">
			...
			<div data-options="region:'north',border:false" >
				<@p.toolbar id="toolbar" listData=[
					 {"id":"btn-search","title":"查询","iconCls":"icon-search","action" : "shipMentDtl.search()", "type":0},
		             {"id":"btn-remove","title":"清空","iconCls":"icon-empty", "action" : "shipMentDtl.clear()","type":0}
		           	 {"id":"btn-export","title":"导出","iconCls":"icon-export", "action" : "shipMentDtl.doExport()","type":0}
		           ]
				/>
			...
			<#--列表-->
        	<div data-options="region:'center',border:false">
		      <@p.datagrid id="shipmentDG"  loadUrl="" saveUrl=""   defaultColumn="" 
		              isHasToolBar="false"    onClickRowEdit="false" pagination="true" 
			           ...
			           columnsJsonList="[
			                  ...
			                  {field : 'purchaseCost', title : '采购价', width : 80,align:'right',halign:'center'},
			                  ...
			                  {field : 'areaAmount', title : '地区额', width : 100,align:'right',halign:'center'},
			                  {field : 'tagPrice', title : '牌价', width : 100,align:'right',halign:'center'}
		                ]" 
                 />
			</div>
	 	</div>
