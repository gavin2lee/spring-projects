<div class="easyui-layout" data-options="fit:true,border:false">
	<div id="entryTab" data-options="region:'center',border:false">
		<@p.datagrid id="entryDataGrid"  loadUrl="" saveUrl=""   defaultColumn="" showFooter="true"
		              isHasToolBar="false"    onClickRowEdit="false" pagination="true" pageSize="20"
			           ...
			           columnsJsonList="[
			                  ...
			                  {field : 'receiveQty', title : '接收数量', width : 80},
			                  {field : 'receiveAmount', title : '接收金额', width : 100},
