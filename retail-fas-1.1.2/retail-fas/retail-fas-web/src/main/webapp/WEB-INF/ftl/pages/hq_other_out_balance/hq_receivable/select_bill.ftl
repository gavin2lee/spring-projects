...
<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/hq_other_stock_out/hqBillSelect.js?version=${version}"></script>
</head>
							...
							<tbody>
								<tr>
									...
									<td>
										...
										data-options="queryUrl: BasePath + '/base_setting/company/list.json?dataAccess=0&params=notGroupLeadRole',required:true,inputNoField:'salerNoId',inputNameField:'salerNameId',inputWidth:160"/>
								...
								<tr>
									...
									<td>
										...
										data-options="required:true,inputNoField:'buyerNoId',inputNameField:'buyerNameId',inputWidth:160"/>
										<input type="hidden" name="buyerNo" id="buyerNoId"/>
									</td>
									<th>品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;牌： </th>
									<td>
       									<input class="easyui-brand  ipt"  id="brandNameId" 
       									data-options="multiple:true,inputNoField:'brandNoId',inputNameField:'brandNameTemp',inputWidth:130"/>
