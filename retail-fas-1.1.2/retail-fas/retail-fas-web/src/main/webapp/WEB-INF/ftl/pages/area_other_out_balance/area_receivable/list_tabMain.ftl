<div class="easyui-layout" data-options="fit:true,border:false">
	<div id="queryConditionDiv" data-options="region:'north',border:false">
		 <@p.billToolBar type="area_other_mainBar"/>
	</div>
				    ...
				    <tbody>
				    	<tr>
						    ...
						    <td>
						        ...
						        data-options="editable:false,valueField:'statusNo',textField:'statusName',url:BasePath + '/area_balance_common/getAHQBalanceBillStatus'"/>
						    </td>
						    <th>品牌部： </th>
							<td>
								<input class="easyui-brandunit ipt"   name="brandUnitName" id="brandUnitNameIdCond" 
								data-options="inputNoField:'brandUnitNoCond',inputNameField:'brandUnitNameIdCond',inputWidth:130"/>
						...
						<tr>
                            ...
                            <td>
	                             ...
	                             data-options="queryUrl: BasePath + '/base_setting/company/list.json?dataAccess=0&params=notGroupLeadRole',inputNoField:'buyerNoCon',inputNameField:'buyerNameCon',inputWidth:160,isDefaultData : false"/>
	   ...
	   <div data-options="region:'center',border:false">
				<@p.datagrid id="mainDataGrid"  
					...
					columnsJsonList="[
						...
						{field : 'status',title : '单据状态',width : 100,align:'center',halign:'center',formatter:areaOtherBalance.statusFormat},
						...
						{field : 'brandUnitName',title : '品牌部',width : 150,align:'center',halign:'center'},			
					...
					jsonExtend='{onDblClickRow:function(rowIndex, rowData){
						areaOtherBalance.loadDetail(rowIndex,rowData);
				}}'/>
			</div>
		</div>
	</div>
