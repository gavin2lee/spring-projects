...
<body class="easyui-layout">
	<@p.commonSetting search_url="/list.json?balanceType=7" 
					  save_url="/insert" 
					  update_url="/update" 
					  del_url="/save"
					  export_url="/do_fas_export"
					  export_title="保证金罚没通知单"
					  export_type="common"
	...
	<div data-options="region:'north',border:false">
    	 <@p.toolbar id="toolbar" listData=[
             ...
             {"id":"btn-add","title":"新增","iconCls":"icon-add","action":"_billCustFineNt.toAdd()", "type":0},
             {"id":"btn-edit","title":"修改","iconCls":"icon-edit","action":"_billCustFineNt.toUpdate()","type":0},
             {"id":"btn-del","title":"删除","iconCls":"icon-del","action":"_billCustFineNt.doDel()","type":0},
             {"id":"btn-audit","title":"审核","iconCls":"icon-aduit","action":"_billCustFineNt.doAudit()","type":0},
			 {"id":"btn-antiAudit","title":"反审核","iconCls":"icon-aduit","action":"_billCustFineNt.doAntiAudit()","type":0},
        ...
        <div data-options="region:'center',border:false" style="height:350px;">
        	 <@p.datagrid id="dataGridDiv"  pagination="true" rownumbers="true"
					...
					jsonExtend='{onDblClickRow:function(rowIndex, rowData){
						_billCustFineNt.toUpdate(rowData);
				}}'/>
        	</div>
      	</div>
	</div>
	    ...
	    <div class="easyui-layout" data-options="fit:true,border:false" >
		     <form name="dataForm" id="dataForm" method="post"  class="pd10">
		     	 <div data-options="region:'north',border:false,height:300" class="pd15">
					<div class="easyui-panel" data-options="title:'保证金罚没通知单',fieldset:true,fit:true,collapsible:false">
						<table cellpadding="1" cellspacing="1" class="form-tb">
						   ...
						   <tr>
                                ...
                                <td width="140" align='left'>
                                	<input class="easyui-validatebox ipt" name="billNo" id="billNo" data-options="required:true,validType:['unNormalData','engNum','maxLength[10]']"/>
                                </td>
                            	<th width="110" align='right'>
                            		<span class="ui-color-red">*</span>单据日期：
                            	</th>
							    <td><input class="easyui-validatebox easyui-datebox ipt" name="billDate" id="billDate" data-options="required:true"/></td>
                            </tr>
                             <tr>
                                <th width="110" align='right'>
                                ...
                                <td><input class="readonly ipt" readonly="true"  name="customerName" id="customerName"/></td>
                            </tr>
                            <tr>
                            	<th width="110" align='right'>
                                ...
                                <td><input class="readonly ipt" readonly="true"  name="marginAmount" id="marginAmount" /></td>
                            </tr>
                            <tr>
                                <th width="110" align='right'>
                                	<span class="ui-color-red">*</span>罚没金额：
                                </th>
                                <td><input class="easyui-numberbox ipt" name="fineAmount" id="fineAmount"  data-options="required:true,precision:2"/></td>
                                <th width="110" align='right'>保证金余额：</th>
                                <td><input class="readonly ipt" readonly="true"  name="recedMarginAmount" id="recedMarginAmount"/></td>
                            </tr>
                            <tr>
...
<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/bill_cust_fine_nt/BillCustFineNt.js?version=${version}"></script>
</body>
</html>