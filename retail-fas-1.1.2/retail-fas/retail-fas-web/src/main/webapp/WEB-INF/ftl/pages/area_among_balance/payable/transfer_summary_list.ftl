<div class="easyui-layout" data-options="fit:true,border:false">
	...
	<div data-options="region:'north',border:false" class="toolbar-region">
		 <@p.billToolBar type="area_among_contrastList_yf"/>
	</div>
	 		
	<div  data-options="region:'center',border:false">
	     <div class="easyui-layout" data-options="fit:true" id="mainSubLayout">
							...
							<tbody>
								<tr>
									...
									<td>
										...
										data-options="queryUrl: BasePath + '/base_setting/company/list.json?dataAccess=0&params=groupLeadRole',inputNoField:'salerNoCond',inputNameField:'salerNameCond',inputWidth:160,isDefaultData : false"/>
