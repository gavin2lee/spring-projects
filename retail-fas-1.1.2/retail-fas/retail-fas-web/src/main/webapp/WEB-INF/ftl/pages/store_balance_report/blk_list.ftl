...
<script type="text/javascript" src="${resourcesUrl}/fas/resources/js/modules/cost/blkStoreBalanceReport.js?version=${version}"></script>
</head>
        	...
        	<div data-options="region:'center',border:false">
		      <@p.datagrid id="dataGridDiv" loadUrl="" saveUrl="" defaultColumn=""  
		              isHasToolBar="false" onClickRowEdit="false" pagination="true" checkOnSelect="true" selectOnCheck="true"
					   ...
					   frozenColumns="[
					   			  {title : '冻结属性',width: 150,align:'left',halign:'center',colspan:'3'},
					   		],[
				                  {field : 'styleNo',title : '款号',width: 100,align:'center',halign:'center'},
			           ...
			           columnsJsonList="[
			                  	  ...
			                  	  {title : '基础属性',colspan:'16'},
			                  	  {title : '期初',colspan:'1'},
			                  	  {title : '期间入',colspan:'10'},
			                  	  {title : '期间出',colspan:'5'},
			                 	  {title : '期间',colspan:'1'},
			                  	  {title : '期末',colspan:'5'}],
				               [
				                  ...
				                  {field : 'closingBalance',title : '期末成本',width: 80,align:'right', exportType:'number'},
				                  {field : 'headquarterCost',title : '总部加权成本',width: 80,align:'right', exportType:'number'},
				                  {field : 'closingHeadquarterCost',title : '总部加权总金额',width: 80,align:'right', exportType:'number'}
			              ]" 
				          jsonExtend='{}'
                 />
			</div>
