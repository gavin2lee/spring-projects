<div class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'north',border:false">
		<@p.billToolBar type="shop_balance_deduct_costbefore_listBar"/>
	</div>

	<#--列表-->
	<div data-options="region:'center',border:false" id="beforeDataGridDiv">
		<@p.datagrid id="shopBalanceDeductBeforeDataGrid"  loadUrl="" saveUrl=""   defaultColumn="" 
			...
			columnsJsonList="[
				...
				{field : 'deductDate',hidden : 'true',title : '扣费日期',width : 80,align:'left',notexport:true,
					editor:{
						type:'datebox',
						options:{
							required:false
				...
				{field : 'deductionName', title : '扣费名称', align:'left',width : 100,halign:'center',
					editor:{
						type:'combogrid',
						options:{
							required:true,
				...
				{field : 'actualAmount',title : '实际扣费金额',width : 90,align:'right',halign:'center',exportType:'number',
					editor:{
						type:'fasnumberbox',
						options:{
				...
				{field : 'diffAmount',title : '扣费差异金额',width : 90,align:'right',halign:'center',exportType:'number',
					editor:{
						type:'readonlytext',
						options:{
							required:false,precision:2,validType:['maxLength[12]']
				...
				{field : 'diffReason',title : '差异原因',width : 100,align:'center',	halign:'center',							
					editor:{
						type:'validatebox',
						options:{
							required:false
				...
				{field : 'costType',title : '费用性质 ',width : 80,align:'center',printable:false,
					formatter: beforeeditor.dataCostType, 
					editor:{
						type:'combobox',
						options:{
				...
				{field : 'processStatus',title : '处理状态',width : 80,align:'center', formatter: beforeeditor.processStatus,
					editor:{
						type:'combobox',
						options:{
						valueField: 'value',  
				...
				{field : 'balanceStatus',title : '结算状态',width : 80,align:'center', formatter: beforeeditor.balanceStatus,notexport:true,
					editor:{
						type:'combobox',
						options:{
							data: [{'value':'1', 'text': '未结算'}, {'value':'2', 'text':'已结算'}, {'value':'3', 'text':'作废'}, {'value':'4', 'text':'已开票'}], 
							valueField: 'value', textField: 'text',
							required:false
						}
					}
				},
				{field : 'costCateCode',hidden:true, title : '总账费用编码', align:'left',width : 50,notexport:true, editor:{type:'hiddenbox',options:{id:'costCateCode',name:'costCateCode'}}},
				...
				{field : 'accountsNo', title : '会计科目编码', width : 100,align:'center',
					editor:{
							type:'readonlybox',
							options:{id:'accountsNo',required:false}
					}
				},
				{field : 'costDeductType',title : '扣取方式 ',width : 80,align:'center',
					formatter: beforeeditor.dataCostDeductType,
					editor:{
						type:'combobox',
						options:{
				...
				{field : 'costPayType',hidden:true,title : '交款方式 ',width : 70,align:'left', formatter: beforeeditor.dataCostPayType,notexport:true,
					editor:{
						type:'combobox',
						options:{
							alueField: 'value', 
				...
				{field : 'basePayCode',title : '支付方式',width : 100,align:'center',
					formatter: beforeeditor.dataBasePayCode, 								
					editor:{
						type:'readonlybox',
						options:{
							required:false
				...
				{field : 'baseOther',title : '其他',width : 100,align:'center',		
					formatter: beforeeditor.dataBaseOther, 						
					editor:{
						type:'readonlybox',
						options:{
							required:false
				...
				{field : 'rateAmount',title : '费率金额',width : 70,align:'right',halign:'center',exportType:'number',exportType:'number',
					editor:{
						type:'readonlybox',
						options:{
							required:false,precision:2,validType:['maxLength[12]']
				...
				{field : 'bsgroupsNo',hidden:true, notexport:true,title : '商场体系', align:'left',width : 80, editor:{type:'hiddenbox',options:{id:'bsgroupsNo_',name:'bsgroupsNo'}}},
				...
				{field : 'mallName', title : '商场', align:'left',halign:'center',width : 90, editor:{type:'searchboxname',options:{id:'mallName_',name:'mallName',readonly:true}}},	
 				{field : 'generateType',title : '生成方式',width : 100,align:'center',notexport:true,		
					formatter: beforeeditor.generateType, 						
					editor:{
						type:'combobox',
						options:{
						valueField: 'value',  
			...
			jsonExtend="{
				onDblClickRow:function(rowIndex, rowData){
					//双击方法
					beforeeditor.editRow(rowIndex, rowData);
				}
			}"
		/>
	</div>
