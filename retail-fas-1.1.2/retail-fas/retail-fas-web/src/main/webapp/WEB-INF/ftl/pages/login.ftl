...
<head>
<meta charset="utf-8">
<meta name="Keywords" content=" , ,百丽,百丽物流运输管理系统" />
<meta name="Description" content=" , ,百丽物流运输管理系统" />
<title>百丽物流运输管理系统</title>
<#include  "/WEB-INF/ftl/common/header.ftl" >

<link href="${resourcesUrl}/fas/resources/css/styles/login/base.css" rel="stylesheet" />
<link href="${resourcesUrl}/fas/resources/css/styles/login/login.css" rel="stylesheet" />
<script>
     $(document).ready(function(){
         ...
         -->
          if (window != top){
               top.location.href=ucSessionCheckedRedirectUrl;
          }else{
             window.location.href =ucSessionCheckedRedirectUrl;
          }   
             ...
             <form id="dataForm" action="<@s.url "/login" />" method="post" >
              ...
              <input type="hidden" name="cookieFlag" id="cookieFlag" value='0'>
                <div class="lgn-form-con">
                    ...
                    <p class="clearfix mt20">
                        <span class="fl">
                        <input type="button" id="btn-search"  name="btn-search" class="lgn-sbmt-btn" value="" onclick="checkForm();" />
                        </span>
                        <span class="fl ml10">
