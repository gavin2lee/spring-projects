 ...
 * 
 */
public interface BillPaymentService extends BaseCrudService {

	int generateByInvoice(List<BillInvoice> oList, 
			String loginName)throws ServiceException;

	int verify(BillPayment obj)throws ServiceException;

	List<BillPayment> selectFooter(Map<String, Object> params)throws ServiceException;
}