...
public class ShopDepositAccountExportFormat extends AbstractExportFormat<SelfShopDepositAccount> {
	@Override
	public Map format(List<String> fields, SelfShopDepositAccount obj) throws Exception {
		Map map = null;
		try {
