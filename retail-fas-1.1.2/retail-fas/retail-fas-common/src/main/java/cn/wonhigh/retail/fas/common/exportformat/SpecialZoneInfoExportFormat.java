...
public class SpecialZoneInfoExportFormat extends AbstractExportFormat<SpecialZoneInfo>{
	@Override
	public Map format(List<String> fields, SpecialZoneInfo obj) throws Exception {
		Map map = null;
		try {
