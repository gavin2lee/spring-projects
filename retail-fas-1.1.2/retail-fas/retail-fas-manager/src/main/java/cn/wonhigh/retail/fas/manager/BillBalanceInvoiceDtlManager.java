 ...
 * 
 */
public interface BillBalanceInvoiceDtlManager extends BaseCrudManager {
	
	int saveAll(Map<CommonOperatorEnum, List<BillBalanceInvoiceDtl>> dataMap) throws ManagerException;
